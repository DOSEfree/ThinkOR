...
from ideaos_agent.api.lark_setup import router as lark_setup_router
from ideaos_agent.api.runtime_capabilities import router as runtime_capabilities_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(lark_setup_router)
